...
Если ваш проект в регулируемом домене, например Healthcare, то желательно чтобы абсолютно все сервисы, которые вы используете соответствовали требованиям которые специфичны в данном домене.
