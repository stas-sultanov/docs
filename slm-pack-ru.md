# Средства обеспечения дизненого цикла решений

Все привет! Меня зовут Стас и по долгу службы мне приходится часто иницировать запуск проектов. Одним из очень часто возникающих вопросов при запуске проекта является выбор средств обеспечения жизненого цикла решения.
