...
Если ваш проект в регулируемом домене, например Healthcare, то желательно чтобы абсолютно все сервисы, которые вы используете соответствовали требованиям специфичными к данному домену.
