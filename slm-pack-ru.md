...
Тут нужно упомянуть что по условиям контрактов абсолютно все артекфакты поражденные во время жизненного цикла решения принадлежат заказчику.
Артефакты - это документация, требования, код, собранные прилоджение, тесты и т.д.

#### 1. Размещение на строрне заказчика
**Плюс :**
...
#### 2. Размещение на строрне исполнителя
**Плюс :**
- Обычно некоторые инструменты развернуты и настроены.
**Минус :**
- Требуется организовать доуступ членам команды со стороны заказчика на сторону исполнителя.
...
Отсебя хочу добавить что вцелом даже на энтерпрайзных проектах на много денег существует определнные проблемы
