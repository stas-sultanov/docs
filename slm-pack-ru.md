...
| Категория               | Роль 
|-------------------------|--------
| Auth                    | Централизованная аутентификации и авторизации пользователей, сервисов и приложений.</br>Все другие средства интегрируются с этим.
...
***Размещение на строрне исполнителя (on-prem)***
...
***Размещение на строрне заказчика (on-prem)***
